...
document.addEventListener("DOMContentLoaded", function () {
    ...
    class ReportScam {
        ...
        constructor() {
            ...
            this.allNavigatorLinks = document.querySelectorAll("ul#navigator li");
        ...
        initialize() {
            ...
            for (let i = 0; i < this.allNavigatorLinks.length; i++) {

                this.allNavigatorLinks[i].addEventListener("click", this.navigatorLinkClickListener.bind(this));
        ...
        navigatorLinkClickListener(event) {

            for (let i = 0; i < this.allNavigatorLinks.length; i++) {

                this.allNavigatorLinks[i].classList.remove(this.activeClass);
